...
#					logfile1.write("    ")
#					logfile1.write(str(self.latestAinValues[1]))
#					logfile1.write("    ")
#					logfile1.write(str(self.latestAinValues[2]))
#					logfile1.write("    ")
#					logfile1.write(str(self.latestAinValues[3]))
#					logfile1.write("    ")
#					logfile1.write(str(self.latestAinValues[4]))
#					logfile1.write("    ")
#					logfile1.write(str(self.latestAinValues[5]))
#					logfile1.write("    ")
...
#yield viztask.waitTime( 0.1)
		logfile1.write("\n")
		yield viztask.waitTime( 0.1)
		logfile1.write(str(tracker.getEuler()))
		logfile1.write("    ")
		logfile1.write(str(viz.tick()))
myTask = viztask.schedule( inertia() ) 
vizact.onkeydown( 'K', myTask.kill )
